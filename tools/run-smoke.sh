...
xcrun swiftc -D PINPOINT_STORE_SMOKE -target arm64-apple-macosx26.0 \
    ...
    Pinpoint/Services/RoundRecapParser.swift Pinpoint/Services/GolfInsights.swift Pinpoint/Services/StrokesGained.swift Pinpoint/Services/RoundStore.swift Pinpoint/Services/OpenAIGolfService.swift \
